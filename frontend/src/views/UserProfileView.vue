    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <form v-else class="space-y-4" @submit.prevent="updateUser">
          <div>
            ...
            <input
              ...
              type="text"
              required
              class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400"
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            :disabled="!hasChanges"
            class="w-full px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition cursor-pointer disabled:opacity-50"
          >
            Update Profile
          </button>
        </form>
      ...
      <div class="w-full p-6 bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <form class="space-y-4" @submit.prevent="updateUserPassword">
          <div>
            <label class="block text-gray-700 font-semibold mb-2" for="currentPassword"
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M9.88 5.09A9.77 9.77 0 0112 4.8c5.05 0 9.27 3.11 10.5 7.2a10.9 10.9 0 01-3.02 4.73M6.61 6.61A10.87 10.87 0 001.5 12c1.23 4.09 5.45 7.2 10.5 7.2 1.94 0 3.76-.46 5.36-1.27"
                  />
                </svg>
                <svg
                  v-else
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M1.5 12c1.23-4.09 5.45-7.2 10.5-7.2s9.27 3.11 10.5 7.2c-1.23 4.09-5.45 7.2-10.5 7.2S2.73 16.09 1.5 12z"
                  />
          ...
          <div>
            <label class="block text-gray-700 font-semibold mb-2" for="newPassword"
              >New Password</label
            >
            <div class="relative">
              <input
          ...
          <button
            type="submit"
            class="w-full px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition cursor-pointer"
          >
            Update Password
          </button>
        </form>
...
async function updateUser() {
  ...
  if (form.lastname !== (originalUser.value?.lastname || ""))
