<template>
  ...
  >
    <!-- Modal -->
    <div
      class="bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-6 space-y-5 border border-gray-100"
    >
      <!-- Header -->
...
async function handleSubmit() {
  ...
  try {
    ...
    useToast().success(
      isEdit.value ? "Project updated successfully" : "Project created successfully",
    );
  } catch (error: unknown) {
